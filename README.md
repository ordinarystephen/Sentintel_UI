...
**The development team inherits the `v1.2.1` tag** — clone `main` at that tag (user text-size control over `v1.2`, which brought bundled fonts, the rem type scale, and the low-DPI token step).
